...
import { discoverByDomain } from "@/lib/insta/pipeline";
import fs from "fs";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    try {
      fs.writeFileSync("discovery_results_insta.json", dataToStore, "utf8");
      console.log("Results successfully saved to discovery_results_insta.json");
    } catch (error) {
